...
class QueryParser:
    ...
    def process_phrase2query(self, phrase : str, splade_encoder=None) -> AbstractOperator:
        '''
    ...
    def parse_pre_and_post(self, idx: int, query_elements: List[str | AbstractOperator], splade_encoder=None) -> List [str | AbstractOperator]:
